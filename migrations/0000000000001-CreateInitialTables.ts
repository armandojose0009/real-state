  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      CREATE TABLE "listing" (
        ...
        CONSTRAINT "FK_listing_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenant"("id") ON DELETE CASCADE
      );
      
      CREATE INDEX "IDX_listing_property_id" ON "listing" ("property_id");
      CREATE INDEX "IDX_listing_tenant_id" ON "listing" ("tenant_id");
      ...
      CREATE TABLE "transaction" (
        ...
        CONSTRAINT "FK_transaction_property" FOREIGN KEY ("property_id") REFERENCES "property"("id") ON DELETE CASCADE,
        CONSTRAINT "FK_transaction_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenant"("id") ON DELETE CASCADE
      );
      
      CREATE INDEX "IDX_transaction_property_id" ON "transaction" ("property_id");
